...
export const ENGLISH_BY_PORTUGUESE: Record<string, string> = {
  ...
  "Ler Código de Barras": "Scan Barcode",
  "Alimento Identificado": "Scanned Food",
  "Sempre Grátis · Sem Anúncios": "Free & No Ads",
  "Digitar Código Manualmente": "Type Barcode Manually",
  "Digitar Código (Apenas dígitos)": "Enter Barcode (Digits)",
  "Quantidade da Porção": "Portion Quantity",
  "Registar Refeição · +30 XP": "Log Meal · +30 XP",
  "Refeição guardada via código de barras · +30 XP": "Meal saved via barcode · +30 XP",
  "A procurar alimento...": "Searching food...",
  "Aponta a câmara para o código de barras do produto": "Point camera at product barcode",
  "Ativar câmara para scan": "Enable camera for barcode scan",
  "Necessário para ler códigos de barras de embalagens e identificar dados nutricionais.": "Required to scan product barcodes and retrieve nutrition facts.",
  "Despesa Metabólica Dinâmica": "Dynamic Metabolic Expenditure",
  "Gasto Diário Estimado": "Estimated Daily Expenditure",
  "Despesa Energética Diária Total": "Total Daily Energy Expenditure (TDEE)",
  "Metabolismo Basal": "Basal Metabolism (BMR)",
  "Treinos / Dia": "Workouts / Day",
  "Ingestão Média": "Avg Intake",
  "Estimativa matemática local; não prescreve calorias nem constitui plano médico.": "Local mathematical estimate; does not prescribe calories or medical plans.",
  "Janela Alimentar": "Eating Window",
  "Superavit Energético": "Energy Surplus",
