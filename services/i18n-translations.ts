/** Mapa de tradução estático PT → EN. */
...
export const ENGLISH_BY_PORTUGUESE: Record<string, string> = {
  ...
  "Desbloquear Sol Pro": "Unlock Sol Pro",
  ...
  "Personaliza a interface com visuais âmbar e acentos solares.":
    "Customise the interface with amber visuals and solar accents.",
  Peso: "Weight",
  ...
  "Tema Brilho Solar": "Solar Glow Theme",
  ...
  "Temas Exclusivos Sol": "Exclusive Sun Themes",
  ...
  "Scanner de Refeições com IA": "AI Meal Scanner",
  "3 / dia": "3 / day",
  "Ilimitado ♾️": "Unlimited ♾️",
  "Proteção de Sequência (Streak)": "Streak Protection",
  "Nenhuma": "None",
  "2 Escudos/mês 🛡️": "2 Shields/mo 🛡️",
  "Resumo básico": "Basic summary",
  "Biologia & Autofagia 🧬": "Biology & Autophagy 🧬",
  "Apenas 16:8": "16:8 only",
  "OMAD, 36h, ADF, Reset ⏱️": "OMAD, 36h, ADF, Reset ⏱️",
  ...
  "Cancela em 1 toque na Google Play": "Cancel anytime on Google Play in 1 tap",
  "COMPARAÇÃO DE PLANOS": "PLAN COMPARISON",
  "GRATUITO": "FREE",
  "OPÇÕES AVULSAS (SEM SUBSCRIÇÃO)": "ONE-TIME PACKS (NO SUBSCRIPTION)",
  "Pack 20 Análises IA": "Pack 20 AI Scans",
  "Escudo de Emergência": "Emergency Streak Shield",
  "Créditos avulsos que nunca expiram": "One-time credits that never expire",
  "Protege 1 falha de sequência": "Protects 1 missed streak day",
  "Comprar Pack": "Buy Pack",
  "Comprar Escudo": "Buy Shield",
  "Nível 10 Sol Invictus": "Level 10 Sol Invictus",
  "Mestre do Fogo Metabólico": "Master of Metabolic Fire",
  "Guardião da Aurora": "Dawn Guardian",
  "Aprendiz da Luz": "Apprentice of Light",
  "Cofre Biométrico": "Biometric Vault",
  "Cofre Biométrico (Sol Pro)": "Biometric Vault (Sol Pro)",
  "Protege os teus registos, fotos e peso com impressão digital ou reconhecimento facial.": "Protect your logs, photos, and weight with fingerprint or face authentication.",
  "Desbloquear com Biometria": "Unlock with Biometrics",
  "Aplicação Bloqueada": "App Locked",
  "Usa a tua impressão digital ou biometria para aceder aos teus dados privados.": "Use your fingerprint or biometrics to access your private data.",
  "Diário Visual": "Visual Diary",
  "Grelha de Pratos": "Meal Gallery",
  "Índice de Saciedade": "Satiety Score",
  "Janela de Fome": "Hunger Window",
  "Verificador de Quebra de Jejum": "Fast-Break Checker",
  "Verificar Rótulo / Bebida": "Check Label / Drink",
  "Seguro para Jejum": "Fasting Safe",
  "Interrompe o Jejum": "Breaks Fasting",
  "Seguro para Cetose": "Keto Safe",
  "Autofagia Ativa": "Autophagy Preserved",
  "Autofagia Interrompida": "Autophagy Interrupted",
  "Personaliza a tua rotina": "Personalize your routine",
  "Responde a duas perguntas para adaptarmos o mostrador ao teu ritmo.": "Answer two quick questions so we can match the dial to your rhythm.",
  "Passo 1 de 2": "Step 1 of 2",
  "Passo 2 de 2": "Step 2 of 2",
  "Qual é o foco principal da tua rotina?": "What is the main focus of your routine?",
  "Queima de Gordura & Leveza": "Fat Burning & Lightness",
  "Estimular o metabolismo e a queima de reservas corporais.": "Boost metabolism and tap into energy reserves.",
  "Autofagia & Renovação Celular": "Autophagy & Cellular Renewal",
  "Promover a longevidade e a limpeza metabólica celular.": "Promote longevity and cellular metabolic cleanup.",
  "Clareza Mental & Disciplina": "Mental Clarity & Discipline",
  "Estabilizar níveis de energia e foco cognitivo constante.": "Steady energy levels and sustained cognitive focus.",
  "Qual é a tua experiência com jejum?": "What is your fasting experience?",
  "Iniciante": "Beginner",
  "Primeira vez ou faço jejum de forma esporádica.": "First time or fasting occasionally.",
  "Intermédio": "Intermediate",
  "Já pratico 14h ou 16h com frequência semanal.": "I already practice 14h or 16h weekly.",
  "Avançado": "Advanced",
  "Habituado a janelas longas (18h, 20h ou 24h).": "Used to longer windows (18h, 20h or 24h).",
  "SUGESTÃO INICIAL": "INITIAL SUGGESTION",
  "Sugerimos esta janela para começares com equilíbrio. Terás total liberdade para ajustar nas definições.": "We suggest this window for a balanced start. You can adjust it anytime in settings.",
  "Acompanhamento de estilo de vida; não constitui prescrição médica ou dietética.": "Lifestyle tracking; not a medical or dietary prescription.",
  "Começar a Minha Jornada": "Start My Journey",
  "Primeiro Treino": "First Workout",
  "7 Dias Seguidos": "7-Day Streak",
  "“Hábitos ao meu ritmo.”": "“Habits at my own pace.”",
  "Jejum Concluído! ☀️": "Fast Completed! ☀️",
  "Excelente consistência. Aqui está o teu cartão circadiano.":
    "Outstanding consistency. Here is your circadian share card.",
  "Partilhar Conquista (Stories / WhatsApp)": "Share Achievement (Stories / WhatsApp)",
  "Continuar para a app": "Continue to App",
  "O cartão de jejum ainda não está pronto para partilhar.":
    "The fast card is not ready to share yet.",
  "Imagem e link partilhados com sucesso.": "Image and link shared successfully.",
};
