...
export function FastingControls({ currentGoalId, isActive, isSaving }: FastingControlsProps) {
      ...
      <View className="mt-5">
        {!isActive ? (
          <Pressable
            ...
            <Text className="ml-2 font-headline text-base text-[#002113]">Iniciar Jejum</Text>
          </Pressable>
        ) : (
          <Pressable
            ...
            <View
              ...
              <View className="mb-5 flex-row items-start justify-between">
                <View className="flex-1 pr-4">
                  <Text className="font-headline text-2xl text-foreground">Objetivo de jejum</Text>
                ...
                {FASTING_GOALS.map((goal) => {
                  ...
                  return (
                    <Pressable
                      ...
                      <View>
                        <Text className="font-headline text-xl text-foreground">{goal.id}</Text>
                        <Text className="mt-0.5 font-body text-xs text-muted">
                          {goal.fastingHours}h de jejum · {goal.eatingHours}h de janela
                        </Text>
                      </View>
                      <Ionicons
