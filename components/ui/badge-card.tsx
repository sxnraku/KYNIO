...
export function BadgeCard({ badge }: BadgeCardProps) {
  ...
  return (
    <View
      ...
      style={{ borderColor: badge.unlocked ? COLORS.xp : COLORS.border, opacity: badge.unlocked ? 1 : 0.55 }}>
      ...
      <Text className="mt-5 font-headline text-base leading-5 text-foreground">{badge.title}</Text>
      <Text className="mt-2 font-body text-xs leading-4 text-muted">{badge.description}</Text>
      <Text className="mt-auto pt-4 font-label text-[9px] uppercase" style={{ color: accentColor }}>
