    ...
    <Screen>
      ...
      {error ? (
        ...
        >
          ...
          <Text className="flex-1 font-body text-sm leading-5 text-[#BE123C]">
            {error}
          </Text>
        </View>
      ) : null}
      ...
      <View className="mb-4 mt-8 flex-row items-end justify-between px-1">
        <View>
          ...
          <Text className="mt-1 font-body text-sm text-muted">
            Guardada apenas neste dispositivo.
          </Text>
        </View>
        {isLoading ? (
      ...
      <View className="mt-5 rounded-2xl border border-border bg-surface-raised p-4">
        ...
        <Text className="mt-2 font-body text-xs leading-[18px] text-muted">
          As categorias e o esforço percebido são descritivos. Não constituem
          aconselhamento médico ou de treino e não substituem orientação
          profissional adequada ao teu caso.
        </Text>
      </View>
